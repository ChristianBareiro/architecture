...
let kMinExpandHeight: CGFloat = kFullHeaderHeight + (UIApplication.shared.windows.first?.safeAreaInsets.top ?? 0) - 20// 136
...
var kSafeBottomInset: CGFloat { appDelegate.window?.safeAreaInsets.bottom ?? 0 }
